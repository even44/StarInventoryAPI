...
public static class DevEndpoints
{
    public static void MapDevEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        devApi.MapGet("/updateCache", async Task<Results<Ok<CacheUpdateResponse>, InternalServerError>> (bool updateItems, bool updateLocations, ItemCacheDb db, IHttpClientFactory httpClientFactory) =>
        {
