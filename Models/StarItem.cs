...
public class StarItem
{
    ...
    public StarItem(int id, string name, int uexIdentifier, int locationId, int quantity, bool isSharedWithOrganization)
    {
        Id = id;
        Name = name;
    ...
    public static StarItem RandomItem(ItemCacheDb db)
    {
        ...
        return new StarItem(randId, randName, 0, locationId, randQuantity, randIsShared);
